import type { CreateSendInput, CreateSendResponse, DriverSendStatusUpdate, Order } from '@/types/api';
...
export async function updateSendStatus(orderId: number, status: DriverSendStatusUpdate) {
