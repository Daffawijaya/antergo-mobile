...
export default function DriverLayout() { return <><DriverLocationTracker /><Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: Colors.primary, tabBarInactiveTintColor: Colors.subtle, tabBarHideOnKeyboard: true, tabBarStyle: { height: 72, paddingTop: 8, paddingBottom: 9, borderTopColor: Colors.border, backgroundColor: Colors.surface }, tabBarLabelStyle: { fontSize: 11, fontWeight: '700' } }}>
 ...
 <Tabs.Screen name="profile" options={{ title: 'Profile', tabBarIcon: ({ color }) => <SymbolView name={{ ios: 'person.fill', android: 'person', web: 'person' }} size={23} tintColor={String(color)} /> }} />
