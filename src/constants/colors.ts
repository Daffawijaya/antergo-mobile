...
export const Typography = {
  ...
  pageTitle: { fontSize: 26, lineHeight: 32, fontWeight: '800' as const },
...
export const Elevation = {
  card: { shadowColor: '#111827', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 12, elevation: 2 },
  floating: { shadowColor: '#111827', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.12, shadowRadius: 20, elevation: 6 },
} as const;
