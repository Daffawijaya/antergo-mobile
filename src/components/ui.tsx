  ...
  return (
    <View className="gap-2">
      ...
      <TextInput
        ...
        multiline={multiline}
        className={`min-h-12 rounded-lg border bg-surface font-sans text-base text-foreground ${multiline ? "min-h-[92px] pt-3.5" : ""} ${error ? "border-danger bg-surface-muted" : "border-border"}`}
