...
/* ── existing generic item interface ─────────────────────────── */
...
export interface PhotoModeConfig {
  /** Photo kind passed to optimizePhoto, e.g. "avatar" | "document". */
  kind: PhotoKind;
  /** Called after the photo is picked & optimised. */
  onPicked: (photo: OptimizedPhoto) => void;
  /** When provided, a "Hapus Foto" danger item is shown. */
  remove?: {
    label?: string;
    onRemove: () => void;
  };
...
interface ActionSheetProps {
  visible: boolean;
  onClose: () => void;
  /** Generic items – used when photoMode is NOT provided. */
  items?: ActionSheetItem[];
  /** When provided, the sheet shows camera/gallery/remove items automatically. */
...
export function ActionSheet({
  ...
  /* ── photo-mode: camera / gallery helpers ────────────────── */
